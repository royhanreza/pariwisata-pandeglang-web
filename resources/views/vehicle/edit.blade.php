            ...
            <div class="card-body">
              ...
              <form autocomplete="off" v-on:submit="store">
                ...
                <div class="form-group">
                  ...
                  <input v-model="merk" type="text" class="form-control form-control-sm" id="merk" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <select v-model="fuel" class="form-control form-control-sm">
                    <option value="">Pilih BBM</option>
                    @foreach ($fuels as $fuel)
                      <option value="{{ $fuel->id }}">{{ $fuel->nama_bbm }}</option>
                    @endforeach
                  </select>
                </div>
                <div class="form-group">
                  <label for="">Jarak Tempuh (KM per liter)</label>
                  <input v-model="distance" type="number" class="form-control form-control-sm" step="any" required>
                </div>
...
<script>
  let app = new Vue({
    ...
    data: {
      ...
      merk: '{{ $vehicle->merk_kendaraan }}',
      type: '{{ $vehicle->jenis_kendaraan }}',
      fuel: '{{ $vehicle->jenis_bbm }}',
      distance: '{{ $vehicle->jarak_tempuh }}',
      loading: false,
    },
    methods: {
      store: function(e) {
        ...
        axios.patch('/api/kendaraan/{{ $vehicle->id }}', { 
          name: this.name,
          merk: this.merk,
          type: this.type,
          fuel: this.fuel,
